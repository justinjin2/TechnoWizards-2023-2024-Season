...
public class Blue_Left_Center_8565 extends Auto_Region {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.followTrajectorySequence(getTrajectories().getBlueLeft_8565(getPosition(), startPose));
            ...
            switch (robotState) {
                ...
                case SLIDE_DOWN:
                            ...
                            (Math.abs(delivery.getMotor2Position()) - 250 < 0))
                    {
                        ...
                        if (getPosition().name().equals("RIGHT") && cycleCounterCenter == scheduledCycleCenter) {
                            sleep(2500);
                        }
                        robotState = RobotState.DELIVERY_DONE;
                        generalTimer.reset();
