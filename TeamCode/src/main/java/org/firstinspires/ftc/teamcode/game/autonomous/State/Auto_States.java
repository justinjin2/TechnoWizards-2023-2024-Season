...
import org.firstinspires.ftc.teamcode.game.autonomous.State.Trajectories_States;
...
public abstract class Auto_States extends LinearOpMode {
    ...
    private Trajectories_States trajectories;
    ...
    public static int scheduledCycleCenter = 3;
    public int cycleCounterCenter = 3;
    ...
    public Trajectories_States getTrajectories() {
        return trajectories;
    }
    ...
    public  void initDrive() {
        ...
        this.trajectories = new Trajectories_States(drive, intake, delivery, v4Bar, pto, claw);
