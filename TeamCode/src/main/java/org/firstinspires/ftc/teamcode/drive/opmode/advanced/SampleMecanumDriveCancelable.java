package org.firstinspires.ftc.teamcode.drive.opmode.advanced;
...
public class SampleMecanumDriveCancelable extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(12, 1, 0);

    public static double LATERAL_MULTIPLIER = 1.699140702924;
    ...
    public SampleMecanumDriveCancelable(HardwareMap hardwareMap) {
        ...
        setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap)); // Added
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        ...
        leftRear.setPower(v1 - (v1 * 0.01));
        rightRear.setPower(v2 - (v2 * 0.02));
        rightFront.setPower(v3 - (v3 * 0.03));
//        leftFront.setPower(v);
